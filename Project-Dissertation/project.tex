...
\usepackage{mathptmx}
%\usepackage{setspace}z
%\onehalfspacing
\usetikzlibrary{mindmap,shadows, shapes, arrows, positioning}

\newcommand{\projecttitle}{Machine Learning Football Playing Agents}
\newcommand{\projectauthor}{Ryan Conway \\[0.2cm] Brian Doyle \\[0.2cm] James Kinsella}
\newcommand{\projectadvisor}{Daniel Craig and Gerard Harrison}
\newcommand{\projectprogramme}{B.Sc.(Hons) in Software Development}
\newcommand{\projectdate}{April 26, 2019}
